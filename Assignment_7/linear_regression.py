        ...
        if predicted > Y[i+w-1] :
            ...
            if position == 'None' :
               ...
               short_open_position = i
                 ...
                 profit_loss = long_shares * (long_selling_price - long_buying_price)
                 profit_loss_list.append(profit_loss)
...
try :
    ...
    print('\nFrom the above graph we can see that the value of r square is quite '
          ...
          'So, in this case, linear regression model is not a good fit for our data. ')
    ...
    print('\n 1. The results are not same for both the years.\n '
          ...
          '4. Long position resulted in loss for 2018 but was profitable in 2019. ')
